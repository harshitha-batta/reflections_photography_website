...
const userSchema = new mongoose.Schema(
  {
    ...
    bio: { type: String, default: '' }, // Add a bio field for profiles
    uploadedPhotos: [{ type: mongoose.Schema.Types.ObjectId, ref: 'Photo' }], // Photos uploaded by the user
    likedPhotos: [{ type: mongoose.Schema.Types.ObjectId, ref: 'Photo' }], // Photos liked by the user
  },
  { timestamps: true }
);
